...
def main():
    ...
    global zero
    pos_1 = str(zero + 30*pwm_per_degree_first_half)
    pos_2 = str(zero + 30*pwm_per_degree_second_half)


    while True:
        

        os.system("echo " + pos_1 + " > /sys/class/pwm/pwmchip0/pwm14/duty_cycle")
        os.system("echo " + pos_2 + " > /sys/class/pwm/pwmchip0/pwm13/duty_cycle")
        time.sleep(1)
        os.system("echo " + pos_2 + " > /sys/class/pwm/pwmchip0/pwm14/duty_cycle")
        os.system("echo " + pos_1 + " > /sys/class/pwm/pwmchip0/pwm13/duty_cycle")
        time.sleep(1)
